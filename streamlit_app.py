...
# Get the directory of the Logistic regression folder
current_dir = os.path.dirname(os.path.abspath(__file__))
logistic_dir = os.path.join(current_dir, 'Logistic regression')
model_path = os.path.join(logistic_dir, 'titanic_model.pkl')
data_path = os.path.join(logistic_dir, 'Titanic_train.csv')
...
st.sidebar.write("""
1. Ensure `streamlit_app.py` and the `Logistic regression/` folder are in the same directory
